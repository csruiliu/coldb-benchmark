...
BENCHMARK TABLES
Load+create Data and shut down of tbl2 which has 4 attributes
DROP TABLE IF EXISTS tbl2B CASCADE;
CREATE TABLE tbl2B (col1 int, col2 int, col3 int, col4 int);

COPY tbl2B FROM '/home/cs165/cs165-management-scripts/project_tests_2017/data2B-ps.csv' WITH (FORMAT csv, DELIMITER ',');

INSERT INTO tbl2B (col1,col2,col3,col4)  VALUES (-1,-11,-111,-1111);
INSERT INTO tbl2B (col1,col2,col3,col4)  VALUES (-2,-22,-222,-2222);
INSERT INTO tbl2B (col1,col2,col3,col4)  VALUES (-3,-33,-333,-2222);
INSERT INTO tbl2B (col1,col2,col3,col4)  VALUES (-4,-44,-444,-2222);
INSERT INTO tbl2B (col1,col2,col3,col4)  VALUES (-5,-55,-555,-2222);
INSERT INTO tbl2B (col1,col2,col3,col4)  VALUES (-6,-66,-666,-2222);
INSERT INTO tbl2B (col1,col2,col3,col4)  VALUES (-7,-77,-777,-2222);
INSERT INTO tbl2B (col1,col2,col3,col4)  VALUES (-8,-88,-888,-2222);
INSERT INTO tbl2B (col1,col2,col3,col4)  VALUES (-9,-99,-999,-2222);
INSERT INTO tbl2B (col1,col2,col3,col4)  VALUES (-10,-11,0,34);


DROP TABLE IF EXISTS tbl3B CASCADE;
DROP TABLE IF EXISTS tbl5B CASCADE;
CREATE TABLE tbl3B (col1 int, col2 int, col3 int, col4 int);
CREATE TABLE tbl5B (col1 int, col2 int, col3 int, col4 int);
COPY tbl3B FROM '/home/cs165/cs165-management-scripts/project_tests_2017/data3B-ps.csv' WITH (FORMAT csv, DELIMITER ',');
COPY tbl5B FROM '/home/cs165/cs165-management-scripts/project_tests_2017/data5B-ps.csv' WITH (FORMAT csv, DELIMITER ',');
